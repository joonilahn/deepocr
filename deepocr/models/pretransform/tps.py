...
class ASTERTPS(nn.Module):

    """TPS Module for ASTER Transformation."""

    def __init__(
        self, output_image_size=None, num_control_points=None, margins=(0.05, 0.05)
    ):
        super(ASTERTPS, self).__init__()
