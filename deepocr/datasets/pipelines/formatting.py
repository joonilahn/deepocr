...
class ToDataContainer(object):
    ...
    def __init__(
        self, fields=(dict(key="img", stack=True), dict(key="gt_label"),),
    ):
        self.fields = fields
...
class DefaultFormatBundle(object):
    ...
    - gt_label: (1)to tensor, (2)to DataContainer
    """
...
class Collect(object):
    ...
    "gt_bboxes_ignore", "gt_label", and/or "gt_masks".
